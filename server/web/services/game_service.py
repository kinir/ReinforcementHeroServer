...
def insert_game(game_name, env_id, due_date, num_of_episods, submissions):
    game = Game(
        game_name=game_name,
        env_id=env_id,
        due_date=due_date,
...
def set_submission(self, game_id):
    self.submissions = submission_service.find_submissions_by_game(game_id)